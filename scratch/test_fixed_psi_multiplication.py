#!/usr/bin/env python3
"""
SOL Analog Conduit Multiplication with Fixed Psi Modulation
============================================================
Ensures that the Mixer node's psi is modulated at full amplitude by updating
both 'psi' and 'psi_bias' at each step, preventing internal relaxation from
damping the demodulation wave.
"""
...
def run_multiplication_trial(A1: float, A2: float, dt: float, steps: int, c_press: float, damping: float, phase_offset: float) -> float:
    ...
    for s in range(steps):
        ...
        # Drive both Mixer psi and psi_bias to bypass relaxation overwriting
...
def main():
    print("======================================================================")
    print("  SOL TWO-SOURCE MANIFOLD MULTIPLICATION (FIXED PSI MODULATION)")
    print("======================================================================")
    ...
    print("----------------------------------------------------------------------")
    print("  Analog Computing Scaling Analysis (Fixed Psi):")
    print("----------------------------------------------------------------------")
