# RUN BUNDLE — dual_inject_timing (2026-02-07 22:50)

## Identity
- seriesName: dual_inject_timing
...
## Question
Does injecting consciousness at step 100 after an initial grail injection change the entropy trajectory?
...
- ✓ mass_conservation: Mass bounded: max=49.79 <= injected=80.00

## Falsifiers
- Entropy curve is identical whether consciousness is injected or not
- Second injection has no visible effect on flux

## Notes
Tests deferred injection support and multi-injection interaction.
