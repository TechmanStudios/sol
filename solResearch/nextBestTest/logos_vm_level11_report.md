...
| :--- | :---: | :---: | :---: |
| `min_active_register_mass` | 575.09 | $\ge 14.0$ | OK |
...
- **Automatic Calibration**: The self-calibrating phase suite successfully compensated for path propagation delays across all 4 frequencies (periods 10, 14, 18, 22), locking matching gates precisely onto their constructive peaks.
