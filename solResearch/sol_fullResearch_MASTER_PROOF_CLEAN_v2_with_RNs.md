...
- README_SOL.md
- SOL Dashboard HTML ([ARTIFACT: local] `sol_dashboard_v3_7_2.html`) [and [ARTIFACT: external] `sol_dashboard_v3_6.html` if you keep it for history]
...
# BEGIN FILE: solResearchNote1.md
## **SOL Research Note**
...
* 16g summary: `[ARTIFACT: external] `sol_phase311_16g_gapSweep_v1_2026-01-11T07-14-58-939Z_2026-01-11T07-36-37-298Z_MASTER_summary.csv``

* 16i summary/trace:

  * `[ARTIFACT: external] `sol_phase311_16i_simulPulseAmpGapMap_v1_2026-01-11T16-55-59-158Z_2026-01-11T17-24-40-224Z_MASTER_summary.csv``

  * `[ARTIFACT: external] `sol_phase311_16i_simulPulseAmpGapMap_v1_2026-01-11T16-55-59-158Z_2026-01-11T17-24-40-224Z_MASTER_busTrace.csv``

* 16j summary/trace:

  * `[ARTIFACT: external] `sol_phase311_16j_simulPulseRatioMap_v1_2026-01-11T17-48-01-398Z_2026-01-11T18-11-33-114Z_MASTER_summary.csv``

  * `[ARTIFACT: external] `sol_phase311_16j_simulPulseRatioMap_v1_2026-01-11T17-48-01-398Z_2026-01-11T18-11-33-114Z_MASTER_busTrace.csv``

* 16k summary/trace:

  * `[ARTIFACT: external] `sol_phase311_16k_lowAmpBoundaryScan_v1_2026-01-11T18-32-24-962Z_2026-01-11T18-58-39-166Z_MASTER_summary.csv``

  * `[ARTIFACT: external] `sol_phase311_16k_lowAmpBoundaryScan_v1_2026-01-11T18-32-24-962Z_2026-01-11T18-58-39-166Z_MASTER_busTrace.csv``

* 16l summary/trace:

  * `[ARTIFACT: external] `sol_phase311_16l_ridgeScanOnsetDelay_v1_2026-01-11T19-18-35-047Z_2026-01-11T19-43-03-964Z_MASTER_summary.csv``

  * `[ARTIFACT: external] `sol_phase311_16l_ridgeScanOnsetDelay_v1_2026-01-11T19-18-35-047Z_2026-01-11T19-43-03-964Z_MASTER_busTrace.csv``

**Running / to be analyzed next**

* 16m outputs (expected): [ARTIFACT: external] `MASTER_summary.csv` \+ [ARTIFACT: external] `MASTER_busTrace.csv` from `solPhase311_16m`.

# END FILE: solResearchNote1.md
...
# BEGIN FILE: solResearchNote2.md
...
* [ARTIFACT: external] `sol_phase311_16m_*_MASTER_summary.csv`, [ARTIFACT: external] `*_MASTER_busTrace.csv`

* [ARTIFACT: external] `sol_phase311_16v_*_MASTER_summary.csv`, [ARTIFACT: external] `*_MASTER_busTrace.csv`

* [ARTIFACT: external] `sol_phase311_16w_*_MASTER_summary.csv`, [ARTIFACT: external] `*_MASTER_busTrace.csv`

* [ARTIFACT: external] `sol_phase311_16x_*_MASTER_summary.csv`, [ARTIFACT: external] `*_MASTER_busTrace.csv`  
   (plus 16n/16o/16p/16q/16r/16s/16t/16u runs captured earlier in the chat)

Code baselines/infrastructure:

* [ARTIFACT: external] `SOLBaseline_v1.3.js` (baseline restore)

* [ARTIFACT: external] `solPhase311_16m.js` (reference for 16m harness style)

* dashboard upgrades: [ARTIFACT: local] `sol_dashboard_v3_7_2.html` (current)
